...
<main>
	<div class="inner">
		...
		<div id="contents">
			...
			<form method="POST" action="BoardReplyWriteProcess.do" id="join" class="form">
				<table>
					<colgroup>
						<col style="width: 20%">
						<col style="width: 80%">
					...
					<tbody>
						...
						<tr>
							...
							<td class="left"><textarea placeholder="내용을 입력하세요." name="user_contents"
