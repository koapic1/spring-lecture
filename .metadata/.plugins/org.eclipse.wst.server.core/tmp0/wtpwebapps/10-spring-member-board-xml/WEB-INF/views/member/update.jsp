    ...
    <main>
      <div class="inner">
		  ...
		  <div id="contents">
		  	...
		  	<form method="POST" action="MemberUpdateProcess.do" id="join" class="form">
		  		<table class="left">
		  			<colgroup>
		  				<col style="width:20%">
		  				<col style="width:80%">
		  			...
		  			<tbody>
		  				<tr>
		  					...
		  					<td>
		  						<input type="text" name="user_id" id="user_id" value="${loggedId }" readonly class="readonly">
		  					</td>
		  				</tr>
		  				<tr>
		  				...
		  				<tr>
		  					...
		  					<td><input type="text" name="user_name" id="user_name" value="${loggedName }" placeholder="이름을 입력하세요."></td>
		  				</tr>
		  				<tr>
